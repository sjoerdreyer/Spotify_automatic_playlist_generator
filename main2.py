...
for a in range(0, 700, 7):
    '''
    I know this is not great code, the artists were every 7 lines in the output I was getting from the web-scraping (soup.select above), so this was my solution to this. If someone is reading this, maybe you have a better solution? 
    '''
